        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto ">
          <div className="text-xl flex justify-end   lg:flex-grow ">
            <a
              ...
              className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-blue-600 mr-6"
            >
              Home Page
            </a>
            <a
            ...
            <a
              href="#responsive-header"
              className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-blue-600 mr-10"
            >
              Contact
            </a>
          </div>
