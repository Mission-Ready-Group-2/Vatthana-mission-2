  ...
  return (
    <>
      {/* <div className="flex justify-center space-x-3 m-3">
        <a>Cars</a> <span>|</span>
        <a>Turners Subsription</a> <span>|</span>
        <a>Trucks & Machinery</a> <span>|</span>
        <a>Damaged & End of Life</a> <span>|</span>
        <a>Motorcycles</a> <span>|</span>
        <a>General Goods</a> <span>|</span>
        <a>Buses, Caravans & Motorhomes</a>
      </div> */}
      ...
      {/* <nav className="flex items-center justify-between flex-wrap bg-blue-300 p-6">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto ">
          <div className="text-xl flex justify-end   lg:flex-grow ">
            <a
              href="#responsive-header"
              className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-blue-600 mr-6 semi-bold text-2xl"
            >
              Home Page
            </a>
            <a
            ...
            <a
              href="#responsive-header"
              className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-blue-600 mr-10 semi-bold text-2xl"
            >
              Contact
            </a>
          </div>
